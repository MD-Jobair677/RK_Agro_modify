...
class WithdrawMethodController extends Controller
{
    ...
    function create() {
        ...
        return view('admin.gateways.manual.create', compact('pageTitle', 'method', 'form', 'formHeading', 'actionRoute', 'backRoute'));
    }
    ...
    function edit($id) {
        ...
        return view('admin.gateways.manual.create', compact('pageTitle', 'method', 'methodRelation', 'form', 'formHeading', 'actionRoute', 'backRoute'));
    }

...
class DepositController extends Controller
{
    ...
    public function deposit()
    {
        ...
        return view('admin.deposit.index', compact('pageTitle', 'deposits','successful','pending','rejected','initiated'));
    }
    ...
    public function approve($id)
    {
        ...
        return to_route('admin.deposit.pending')->withToasts($notify);
    }

...
{
    function versatile() {
        $pageTitle = 'Versatile Template for Notification';
        return view('admin.notification.versatileTemplate',compact('pageTitle'));
    }

    function versatileUpdate() {
        ...
        $toast[] = ['success', 'Versatile  notification settings update successfully'];

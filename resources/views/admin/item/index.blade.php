        ...
        <div class="col-xxl">
            <div class="card">
                <div class="card-body table-responsive text-nowrap fixed-min-height-table">
                    <a href="{{ route('admin.common.item.create') }}" class="btn btn-sm btn-success">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">@lang('Item Code')</th>
                                <th class="text-center">@lang('Name')</th>
                                <th class="text-center">@lang('Record Level')</th>
                                <th class="text-center">@lang('Unit of Measurement')</th>
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->record_level }}</td>
                                    ...
                                    <td class="text-center">
                                        <div>
                                            ...
                                            <a href="{{ route('admin.common.item.edit', $item->id) }}" class="btn btn-sm btn-warning">

...
@section('master')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <form class="card-body" action="{{ route('admin.inventory.stock.store') }}"method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-select" name="supplier_id"
                                                    ...
                                                    @foreach ($suppliers ?? [] as $item)
                                                        <option value="{{ $item->id }}">{{ ucfirst($item->fullname) }}
                                                            ({{ $item->contact_number }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="sup_name"
                                                            value="{{ old('sup_name') }}" placeholder="@lang('Enter Supplier Name')"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="expense_type" value="{{ $expTyp }}" required>
                                                <select class="form-select" name="item_id" required>
                                                    @if (!empty($items))
                                                        {
                                                        <option> @lang('Selelct One')</option>
                                                    ...
                                                    @elseif($storeItem)
                                                        {
                                                        <option value="{{ $storeItem->id }}"> {{ $storeItem->name }}
                                                        </option>
                                                        }
                                                    @endif
                                                </select>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="stock_in" min="0" step="any"
                                                            value="{{ old('stock_in') }}" placeholder="@lang('Enter Stock Level')"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="uom"
                                                            value="{{ old('uom') }}" placeholder="@lang('Enter Unit Of Measurement')"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="rate_per_unit" min="0" step="any"
                                                    value="{{ old('rate_per_unit') }}" placeholder="@lang('Enter Rate Per Unit')"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" rows="5" cols="5" name="reference"
                                                    placeholder="@lang('Enter Reference')">{{ old('reference') }}</textarea>
                                            </div>
                                        </div>

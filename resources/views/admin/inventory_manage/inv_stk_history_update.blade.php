...
@section('master')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <form class="card-body" action="{{ route('admin.inventory.inventory.stock.history.update', $itemDetails->id) }}"method="POST"
                                    ...
                                    <div class="row">
                                                ...
                                                <select name="supplier_id" class="form-control">
                                                    @foreach ($suppliers ?? [] as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ isset($itemDetails) && $itemDetails->supplier->id == $item->id ? 'selected' : '' }}>
                                                            {{ ucfirst($item->fullname) }} ({{ $item->contact_number }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-12 col-md-12 mb-3 newSupplier">
                                            <div class="row">
                                                {{-- <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label required">@lang('Supplier Category')</label>
                                                ...
                                                {{-- <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label required">@lang('Supplier Name')</label>
                                                        <input type="text" class="form-control" name="sup_name"
                                                            value="{{$itemDetails->supplier->last_name . ' ' . $itemDetails->supplier->first_name}}" placeholder="@lang('Enter Supplier Name')"
                                                            required>
                                                    </div>
                                                </div> --}}
                                                {{-- <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="contact_number"
                                                            value="{{ $itemDetails->supplier->contact_number }}"
                                                ...
                                                {{-- <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control" rows="5" cols="5" name="sup_address"
                                                            placeholder="@lang('Enter Supplier Address')">{{ $itemDetails->supplier->address }}</textarea>
                                                    </div>
                                                </div> --}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="expense_type"
                                                    value="{{ $expTyp }}" required>
                                                <select class="form-select" name="item_id" required>
                                                   
                                                    @foreach ( $storeItem as $item )
                                                        <option value="{{ $item->id }}"
                                                            {{ isset($itemDetails) && $itemDetails->item->id == $item->id ? 'selected' : '' }}>
                                                            {{ __($item->name) }}
                                                        </option>
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="col-form-label required">@lang('Select Warehouse')</label>
                                                  <select name="warehouse_id" id="" class="form-select" required>
                                               @foreach ($warehouse as $warehous)
                                              
                                                    <option value="{{ $warehous->id }}"
                                                        {{ isset($itemDetails) && $itemDetails->warehouse->id == $warehous->id ? 'selected' : '' }}>
                                                        {{ __($warehous->name) }}
                                                    </option>
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        <label class="col-form-label required">@lang('Stock In')</label>
                                                        <input type="number" class="form-control" name="stock_in"
                                                            min="0" step="any" value="{{$itemDetails->quantity_in}}"
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="uom"
                                                            value="{{ $itemDetails->unit_of_measurement }}" placeholder="@lang('Enter Unit Of Measurement')"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="col-form-label required">@lang('Rate Per Unit')</label>
                                                <input type="number" class="form-control" name="rate_per_unit"
                                                    min="0" step="any" value="{{ $itemDetails->rate_per_unit }}"
                                        ...
                                        <div class="col-lg-12 col-md-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input name="purchase_date" id="datepicker" type="text"
                                                    ...
                                                    placeholder="@lang('Purchase date')" autocomplete="off"
                                                    value="{{ isset($itemDetails) ? date('Y-m-d', strtotime($itemDetails->purchase_date)) : '' }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" rows="5" cols="5" name="note"
                                                    placeholder="@lang('Note')">{{ $itemDetails->note }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" rows="5" cols="5" name="remark"
                                                    placeholder="@lang('Enter Remark')">{{ $itemDetails->remark }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                <label class=" col-form-label">@lang('Reference')</label>
                                                <textarea type="text" class="form-control" rows="5" cols="5" name="reference"
                                                    placeholder="@lang('Enter Reference')">{{ $itemDetails->reference }}</textarea>
                                            </div>
                                        </div>
...
@push('breadcrumb')
    <a href="{{ route('admin.inventory.stock.index', $itemDetails->warehouse->name) }}" class="btn btn-label-primary">

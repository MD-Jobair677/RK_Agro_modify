                                    ...
                                    <td class="text-center">
                                        <div>
                                            <button type="button" class="btn btn-sm btn-label-info detailBtn"
                                                ...
                                                data-customer="{{ $item }}" 
                                                data-customer_image_path="{{ getImage(getFilePath('supplier') . '/' . $item->image_path) }}"
                                                aria-controls="offcanvasBoth">
                                                <span class="tf-icons las la-info-circle me-1"></span>
                                                @lang('Details')
                                            </button>
                                            <a href="{{ route('admin.supplier.edit', $item->id) }}" class="btn btn-sm btn-warning">
...
@push('breadcrumb')
    <x-searchForm placeholder="Search supplier name or number..." dateSearch="no" />
@endpush
